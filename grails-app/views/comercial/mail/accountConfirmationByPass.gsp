...
<html lang="en">
	...
	<style>
		...
		<div style="width:65%;float:center">
			<div style="background-color:#1f9dd9; ">
			...
			<p style="padding-right:0px"><g:message code="general.mail.body.accountConfirmationByPass" args="${[username, associatedClient]}"/></p>
