...
<html lang="en">
	...
	<style>
		...
		<div style="width:65%;float:center">
			...
			<h3><b ><g:message code="general.mail.paymentConfirmation.title"/></b></h3>
			<p style="padding-right:0px"><g:message code="general.mail.paymentConfirmation.body" args="${[username]}"/></p>
