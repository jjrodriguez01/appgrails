...
<div class="form-wrapper" >
	...
	<form action="${createLink(controller:'register', action:'verifyAccountByPassword')}" method="POST" id="passwordForm" class="form-signin wow fadeInUp" autocomplete="off">
		<h2 class="form-signin-heading" >
			<g:message code='general.mail.title.accountConfirmation'/>
		</h2>
		<div class="login-wrap">
		<h5 style="margin-bottom:20px"><g:message code="general.mail.verifyAccountByPasswordMessage" args="${[fullname]}"/></h5>
			...
			<input class="btn btn-lg btn-login form-control"  type="submit" id="submit" value="<g:message code='general.mail.button.accountConfirmation'/>"/>	
	</div>
</form>
</div>
</div>
