		...
		<div class="box-body">
          ...
          <div class="info-box bg-green">
            ...
            <div class="info-box-content" id="scenariosInfo">
              ...
              <span class="info-box-number">${choosenPj.scenarios.flatten().size()}</span>
              
              <div class="progress">
                <div class="progress-bar" style="width: ${choosenPj.scenarios.flatten().size()*5%100}%"></div>
                <div class="progress-bar"></div>
              </div>
                  <span class="progress-description">
                      <g:message code="statistic.message.scenarios" args="[choosenPj.scenarios.flatten().size()]"/>
                  </span>
            </div>
            <!-- /.info-box-content -->
          </div>
          ...
          <div class="info-box bg-red">
            ...
            <div class="info-box-content" id="casesInfo">
              ...
              <span class="info-box-number">${choosenPj.scenarios.flatten()*.cases.flatten().size()}</span>
              <span class="info-box-number"></span>

              <div class="progress">
                <div class="progress-bar" style="width: ${choosenPj.scenarios.flatten()*.cases.flatten().size()*5%100}%"></div>
                <div class="progress-bar"></div>
              </div>
                  <span class="progress-description">
                    <g:message code="statistic.message.cases" args="[choosenPj.scenarios.flatten()*.cases.flatten().size()]"/>
                  </span>
            </div>
            <!-- /.info-box-content -->
          </div>
          ...
          <div class="info-box bg-aqua">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">${choosenPj.pages.flatten().size()}</span>

              <div class="progress">
                <div class="progress-bar" style="width: ${choosenPj.pages.flatten().size()*5%100}%"></div>
              </div>
                  <span class="progress-description">
                   <g:message code="statistic.message.pages" args="[choosenPj.pages.flatten().size()]"/>
                  </span>
            </div>
            <!-- /.info-box-content -->
          </div>
...
<script type="text/javascript">
	    ...
	    datasets: [
	        {
	            ...
	            data: [${choosenPj.logs.flatten()*.logs.flatten().count{it.browser.toLowerCase().contains('chrome') && !it.isSuccess}}, ${choosenPj.logs.flatten()*.logs.flatten().count{it.browser.toLowerCase().contains('firefox') && !it.isSuccess}}, ${choosenPj.logs.flatten()*.logs.flatten().count{it.browser.toLowerCase().contains('edge') && !it.isSuccess}}, ${choosenPj.logs.flatten()*.logs.flatten().count{it.browser.toLowerCase().contains('safari') && !it.isSuccess}},${choosenPj.logs.flatten()*.logs.flatten().count{it.browser.toLowerCase().contains('explorer') && !it.isSuccess}},${choosenPj.logs.flatten()*.logs.flatten().count{it.browser.toLowerCase().contains('opera') && !it.isSuccess}}]
	        },
	        {
    ...
    {
        value: ${choosenPj.logs.flatten()*.logs.flatten().count{it.browser.toLowerCase().contains('chrome')}},
        color: "#00a65a",
        highlight: "#3DD991",
        label: "Chrome"
    },
    {
        value: ${choosenPj.logs.flatten()*.logs.flatten().count{it.browser.toLowerCase().contains('firefox')}},
        color: "#f39c12",
        highlight: "#F5BB5F",
        label: "FireFox"
    },
    ...
    {
        value: ${choosenPj.logs.flatten()*.logs.flatten().count{it.browser.toLowerCase().contains('edge')}},
        color: "#0073b7",
        highlight: "#73A9C9",
        label: "Edge"
    },
    {
        value: ${choosenPj.logs.flatten()*.logs.flatten().count{it.browser.toLowerCase().contains('safari')}},
        color: "#d2d6de",
        highlight: "#E6E8ED",
        label:"Safari"
    },
    {
        value: ${choosenPj.logs.flatten()*.logs.flatten().count{it.browser.toLowerCase().contains('explorer')}},
        color: "#00c0ef",
        highlight: "#AEDDE8",
        label: "IE"
    },
    {
        value: ${choosenPj.logs.flatten()*.logs.flatten().count{it.browser.toLowerCase().contains('opera')}},
        color:"#dd4b39",
        highlight: "#E3887D",
        label: "Opera"
    }
	    ...
	    datasets: [
	        {
	            ...
	            data: [${choosenPj.logs.flatten()*.logs.flatten().count{it.dateCreated.toString().substring(5,7) == "01" && it.dateCreated.toString().substring(0,4) == Calendar.getInstance().get(Calendar.YEAR).toString() && it.issuccess}}, ${choosenPj.logs.flatten()*.logs.flatten().count{it.dateCreated.toString().substring(5,7) == "02" && it.dateCreated.toString().substring(0,4) == Calendar.getInstance().get(Calendar.YEAR).toString()  &&  it.issuccess}}, ${choosenPj.logs.flatten()*.logs.flatten().count{it.dateCreated.toString().substring(5,7) == "03" && it.dateCreated.toString().substring(0,4) == Calendar.getInstance().get(Calendar.YEAR).toString()   && it.issuccess}}, ${choosenPj.logs.flatten()*.logs.flatten().count{it.dateCreated.toString().substring(5,7) == "04" && it.dateCreated.toString().substring(0,4) == Calendar.getInstance().get(Calendar.YEAR).toString()  && it.issuccess}}, ${choosenPj.logs.flatten()*.logs.flatten().count{it.dateCreated.toString().substring(5,7) == "05" && it.dateCreated.toString().substring(0,4) == Calendar.getInstance().get(Calendar.YEAR).toString() && it.issuccess}}, ${choosenPj.logs.flatten()*.logs.flatten().count{it.dateCreated.toString().substring(5,7) == "06" && it.dateCreated.toString().substring(0,4) == Calendar.getInstance().get(Calendar.YEAR).toString() && it.issuccess}}, ${choosenPj.logs.flatten()*.logs.flatten().count{it.dateCreated.toString().substring(5,7) == "07" && it.dateCreated.toString().substring(0,4) == Calendar.getInstance().get(Calendar.YEAR).toString() && it.issuccess}}, ${choosenPj.logs.flatten()*.logs.flatten().count{it.dateCreated.toString().substring(5,7) == "08" && it.dateCreated.toString().substring(0,4) == Calendar.getInstance().get(Calendar.YEAR).toString() && it.issuccess}}, ${choosenPj.logs.flatten()*.logs.flatten().count{it.dateCreated.toString().substring(5,7) == "09" && it.dateCreated.toString().substring(0,4) == Calendar.getInstance().get(Calendar.YEAR).toString() && it.issuccess}}, ${choosenPj.logs.flatten()*.logs.flatten().count{it.dateCreated.toString().substring(5,7) == "10" && it.dateCreated.toString().substring(0,4) == Calendar.getInstance().get(Calendar.YEAR).toString() && it.issuccess}}, ${choosenPj.logs.flatten()*.logs.flatten().count{it.dateCreated.toString().substring(5,7) == "11" && it.dateCreated.toString().substring(0,4) == Calendar.getInstance().get(Calendar.YEAR).toString() && it.issuccess}}, ${choosenPj.logs.flatten()*.logs.flatten().count{it.dateCreated.toString().substring(5,7) == "12" && it.dateCreated.toString().substring(0,4) == Calendar.getInstance().get(Calendar.YEAR).toString() && it.issuccess}}]
	        },
	        {
	            label: "${message(code:'general.error')}",
